...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver 400 quando nao informar os dados de agendamento")
    @WithMockUser
    ...
    void agendar_cenario2() throws Exception {
        ...
        var dados = new DadosDetalhamentoConsulta(null, 5l, 2l, data);
        ...
        var jsonEsperado = jsonDadosDetalhamentoConsulta.write(dados).getJson();
