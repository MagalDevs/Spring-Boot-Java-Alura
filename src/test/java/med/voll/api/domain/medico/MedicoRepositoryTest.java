...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico medico cadastrado estiver ocupado na data")
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var paciente = cadastrarPaciente("paciente", "paciente@gmai.com", "12345678901");
    ...
    //métodos privados para auxiliar nos testes
